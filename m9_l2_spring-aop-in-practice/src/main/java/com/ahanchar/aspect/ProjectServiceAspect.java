...
public class ProjectServiceAspect {
    ...
    @Before("execution(* com.ahanchar.service.impl.ProjectServiceImpl.findById(Long))")
    public void before(JoinPoint joinPoint) {
        LOG.info("Searching Project with Id {}", joinPoint.getArgs()[0]);
    }

    @After("within(com.ahanchar.service.impl.ProjectServiceImpl)")
    ...
    @Around("execution(* com.ahanchar.service.impl.ProjectServiceImpl.save(*))")
